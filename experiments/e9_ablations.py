...
Each variant runs through the same E3/E5 evaluation function
(experiments.common.evaluate_gnn).
"""
...
def ablation_grid(
    ...
    edgeless."""
    return [
        AblationConfig(mask, dem, radius, layers, norm)
        for mask, (dem, radius), layers, norm in itertools.product(
